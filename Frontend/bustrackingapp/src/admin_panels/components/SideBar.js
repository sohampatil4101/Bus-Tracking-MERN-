            ...
            <div className="sidebar-content">
                <div className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
                    <ul className="sidebar__links">
                        ...
                        <li>
                            {" "}
                            <Link className="manage-link" to="/login/manage">
                                <i className="fa fa-bus"></i> Manage Bus
                            </Link>
                        </li>
                        <li>
                            {" "}
                            <Link className="terminal-link" to="/login/terminal">
                                <i className="fa fa-compass"></i> Manage Terminal
                            </Link>
                        </li>
                        <li>
                            {" "}
                            <Link className="schedule-link" to="/login/schedule">
                                <i className="fa fa-calendar"></i>  Manage Schedule
                            </Link>
                        </li>
                        <li>
                            {" "}
                            <Link className="bookings-link" to="/login/bookings">
                                <i className="fa fa-book"></i> List Bookings
                            </Link>
                        </li>
                        <li>
                            {" "}
                            <Link className="tickets-link" to="/login/tickets">
                                <i className="fa fa-ticket"></i> Tickets
                            </Link>
                        </li>
                        <li>
                            {" "}
                            <Link className="payments-link" to="/login/payments">
                                <i className="fa fa-dollar"></i>  Payments List
                            </Link>
                        </li>
                        <li>
                            {" "}
                            <Link className="user-link" to="/login/user">
